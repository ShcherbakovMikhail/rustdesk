...
// shcherbakov.m - Указываем Адрес собственного сервера и ключ шифрования 
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.sintec.ru"];
pub const RS_PUB_KEY: &str = "0rwWd6HPDVy+VCQftw7C8VZ+mqm4S+h0DBVtgZ5Qjqw=";
